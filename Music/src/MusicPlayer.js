      ...
      <View style={style.mainContainer}>
        ...
        <View style={style.musicControlsContainer}>
          <TouchableOpacity onPress={() => { }}>
            <Ionicons name="shuffle-outline" size={25} color="#F2F2F2" />
          </TouchableOpacity>
          <TouchableOpacity onPress={skipToPrevious}>
            <Ionicons name="play-skip-back-outline" size={25} color="#F2F2F2" />
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={changeRepeatMode}>
            <MaterialCommunityIcons
              name={`${repeatIcon()}`}
              size={25}
              color={repeatMode !== 'off' ? '#6156E2' : '#F2F2F2'}
            />
          </TouchableOpacity>
        </View>
      </View>
        ...
        <View style={style.bottomIconContainer}>
          ...
          <TouchableOpacity onPress={changeRepeatMode}>
            <MaterialCommunityIcons
              name={`${repeatIcon()}`}
              size={30}
              color={repeatMode !== 'off' ? '#6156E2' : '#888888'}
            />
          </TouchableOpacity>
